...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--name', type=str, default='celeba-120',
        ...
        parser.add_argument('--load_size', type=int, default=112, help='scale images to this size')
        parser.add_argument('--crop_size', type=int, default=112, help='then crop to this size')
        ...
        parser.add_argument('--display_winsize', type=int, default=112,
                            help='display window size for both visdom and HTML')
        # additional parameters
        parser.add_argument('--epoch', type=str, default='latest',
                            help='which epoch to load? set to latest to use latest cached model')
        parser.add_argument('--load_iter', type=int, default='4',
