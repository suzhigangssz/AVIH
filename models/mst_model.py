...
from .pix_model import PixModel
import torch
from skimage import color  # used for lab2rgb
import numpy as np


class mstModel(PixModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        """
        PixModel.modify_commandline_options(parser, is_train)
        parser.set_defaults(dataset_mode='mst')
        return parser
